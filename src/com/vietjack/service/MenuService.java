	...
	public static void authorMenus(){
		...
		while (flag) {
			...
			case 5:
				...
				break;
			case 6 :
				authorService.findAuthorWithRevenue();
				break;
			case 7:
				System.out.println("Return main menu");
				flag = false;
	...
	public static void bookStoreMenus() throws SQLException {
		...
		while (flag) {
			...
			case 1:
				...
				break;
			case 2:
				bookStoreService.topCategoryByRevenueDB();
				break;
			case 3:
				bookStoreService.topAuthorBySoldNumber();
				break;
			case 4:
				bookStoreService.topAuthorByRevenue();
				break;
			...
			case 6:
				...
				break;
			case 7:
				bookStoreService.topCategoryByHeadBook();
				break;
			}
