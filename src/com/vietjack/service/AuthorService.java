...
public class AuthorService {
	...
	public static void findAuthorOfBook() 
	{
		System.out.println("nhap vao id cua tac gia");
		long id = scanner.nextLong();
		ArrayList<Author> authorList=new ArrayList<Author>();
		try {
			authorList = authorDAO.findAuthorOfBook(id);
...
public static void findAuthorWithRevenue(){
	System.out.println("Inut the name");
	String name = scanner.nextLine();
	Author author = null;
	try {
		author = authorDAO.findAuthorWithRevenue(name);
	} catch (Exception e) {
		System.out.println("There is an error when finding a author");
		e.printStackTrace();
	}
	...
	public static void displayAuthorAbove20(){
		System.out.println("Display author above 20 age");
		try {
			ArrayList<Author> listAuthor = authorDAO.findAuthorAbove20();
	...
	public void printAuthorMenu(){
		...
		System.out.println("6. Find author with revenue");
